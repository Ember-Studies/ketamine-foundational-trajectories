...
add_transform_variables <- function(merged_phq_patient_data, max_prior_infusion_threshold, path_data, path_code, path_out, osa_distance_threshold, save_meds_table = FALSE, plot_hist = FALSE){
  ...
  merged_phq_patient_data <- parse_medications(merged_phq_patient_data = merged_phq_patient_data,
                                               osa_distance_threshold = osa_distance_threshold,
                                               path_data = path_data,
                                               path_out = path_out,
                                               save_meds_table = save_meds_table)
